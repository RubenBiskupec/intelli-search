#!/bin/bash
# /Users/rubenbiskupec/Desktop/intelli-search/documents1/documenti
# /Users/rubenbiskupec/Desktop/intelli-search/documents2
...
for FILEPATH in $BPATH*.pdf; do
    ...
    # If that fails, try Tesseract.
     ...
     #   then
            echo -n "Attempting c OCR extraction..."
	        touch  ./temp.tiff
